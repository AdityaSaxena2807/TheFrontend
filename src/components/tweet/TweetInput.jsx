  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        rows={2}
        className="w-full resize-none bg-transparent outline-none text-text-primary placeholder-text-disabled text-base font-body"
      />
      <LoginPromptModal
      ...
      <div className="flex items-center justify-between mt-4 pt-3 border-t border-border">
        <div className="flex items-center gap-3">
          ...
          <span
            className={`text-xs ${
              remaining < 0 ? "text-crimson" : "text-text-disabled"
            }`}
          >
            {remaining}
          </span>
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            variant="primary"
            className="text-xs font-semibold px-5 py-1.5"
          >
